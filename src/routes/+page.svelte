  ...
  <section id="socials" class="flex h-dvh w-full flex-col items-center justify-center px-6 text-center md:px-10 relative z-10">
    <div use:reveal class="mx-auto max-w-4xl">
      ...
      <div class="flex flex-wrap justify-center gap-6 md:gap-8">
        ...
        <a href="https://linkedin.com/company/gdsclsu/" rel="noopener noreferrer" class="group flex h-20 w-20 md:h-24 md:w-24 items-center justify-center rounded-2xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 shadow-sm hover:shadow-xl hover:-translate-y-2 hover:border-[#0077b5] transition-all duration-300">
        ...
        <!-- svelte-ignore a11y_consider_explicit_label -->
        <a href="https://github.com/Google-Developers-Student-Club-LSU" rel="noopener noreferrer" class="group flex h-20 w-20 md:h-24 md:w-24 items-center justify-center rounded-2xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 shadow-sm hover:shadow-xl hover:-translate-y-2 hover:border-slate-900 dark:hover:border-white transition-all duration-300">
        ...
        <!-- svelte-ignore a11y_consider_explicit_label -->
        <a href="https://instagram.com/gdsclsu" rel="noopener noreferrer" class="group flex h-20 w-20 md:h-24 md:w-24 items-center justify-center rounded-2xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 shadow-sm hover:shadow-xl hover:-translate-y-2 hover:border-[#E1306C] transition-all duration-300">
