...
<div
  class="flex items-center flex-col p-6 w-full z-50 absolute top-0
...
>
  <button
    id="logoButton"
    onclick={toggleNav}
    class="flex items-center gap-2 group justify-center w-full transition-all duration-500 ease-in-out transition-discrete"
  >
    <img
      src={gdscLogo}
      alt="GDSC Logo"
      class="h-8 w-auto relative z-10 object-contain"
    />
  </button>
  ...
  <div
    id="navButtons"
    class="relative flex flex-col gap-2 items-center transition-all duration-500 ease-in-out hidden"
  ...
  >
    ...
    <div class="flex flex-col items-center mt-3 z-1">
      <a
        href="/"
        onclick={toggleNav}
        class="font-bold px-4 py-2 rounded-full relative z-10 transition-colors hover:text-primary-color text-xl font-bold"
        >GDSC@LSU</a
      >
      {#if !loading}
        {#if !user}
          <a
            href="/login"
            onclick={toggleNav}
            class="px-4 py-2 rounded-full relative z-10 transition-colors hover:text-primary-color font-bold text-primary-color"
            >Login</a
          >
        {/if}
        <a
          href="/about"
          onclick={toggleNav}
          class="px-4 py-2 rounded-full relative z-10 transition-colors hover:text-primary-color font-medium"
          >About</a
        >
        <a
          href="/events"
        ...
        <a
          href="/sponsor"
          onclick={toggleNav}
          class="px-4 py-2 rounded-full relative z-10 transition-colors font-medium hover:text-primary-color"
          >Sponsor</a
        >
        {#if isOfficer}
          <a
