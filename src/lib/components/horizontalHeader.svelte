<script lang="ts">
  ...
  function getScrollY(): number {
    const lenisInstance = (window as Window & { __lenis?: { scroll?: number } })
      .__lenis;
...
>
  <a href="/" class="flex items-center gap-2 group">
    ...
    />
    <h1
      class="relative z-10 font-bold text-xl whitespace-nowrap group-hover:opacity-80 transition-opacity ml-2"
    >
      GDSC LSU
    </h1>
  </a>
