...
<div
  class="bg-white dark:bg-slate-800 rounded-2xl shadow-xl overflow-auto max-h-[70vh]"
>
  <table class="min-w-full divide-y divide-gray-200 dark:divide-slate-700">
    <thead class="bg-[#9f86ff]/10">
      <tr>
        ...
        <th class="px-6 py-4 text-right w-32 text-[#9f86ff] font-bold"
          >Points</th
        >
      </tr>
    </thead>
    <tbody class="divide-y divide-slate-100">
      {#each sortedMembers as member, index}
        <tr class="hover:bg-[#9f86ff]/5">
          ...
          <td class="px-6 py-4 text-right font-bold text-[#9f86ff]"
            >{member.points} pts</td
          >
        </tr>
      {/each}
    </tbody>
